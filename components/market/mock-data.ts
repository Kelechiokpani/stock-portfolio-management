...
export type PayMethod = "bank_transfer" | "credit_card" | "debit_card" | "digital_wallet"
...
export type Asset = Stock | Bond | ETF | MutualFund | Commodity
...
export const mockETFs: ETF[] = [
  // Index-based ETFs (Stock indices)
  {
    id: "etf-001",
    symbol: "SPY",
    ...
    trackingError: 0.02,
    holdings: [
      { symbol: "AAPL", name: "Apple Inc.", percentage: 7.2 },
      { symbol: "MSFT", name: "Microsoft", percentage: 6.8 },
      { symbol: "GOOGL", name: "Alphabet Inc.", percentage: 4.1 },
      { symbol: "AMZN", name: "Amazon", percentage: 3.9 },
      { symbol: "NVDA", name: "NVIDIA", percentage: 3.5 },
    ],
  },
  {
    id: "etf-002",
    ...
    trackingError: 0.03,
    holdings: [
      { symbol: "AAPL", name: "Apple Inc.", percentage: 11.5 },
      { symbol: "MSFT", name: "Microsoft", percentage: 10.8 },
      { symbol: "NVDA", name: "NVIDIA", percentage: 9.2 },
      { symbol: "GOOGL", name: "Alphabet Inc.", percentage: 6.5 },
      { symbol: "META", name: "Meta Platforms", percentage: 5.1 },
    ],
  },
  {
    id: "etf-003",
    ...
    indexName: "CRSP US Total Market",
    expenseRatio: 0.03,
    nav: 258.45,
    price: 258.67,
    change: 1.85,
    ...
    trackingError: 0.01,
    holdings: [
      { symbol: "AAPL", name: "Apple Inc.", percentage: 6.5 },
      { symbol: "MSFT", name: "Microsoft", percentage: 6.2 },
      { symbol: "GOOGL", name: "Alphabet Inc.", percentage: 3.8 },
    ],
  },
  // Bond ETFs
  {
    ...
    indexName: "Bloomberg Aggregate Bond",
    expenseRatio: 0.03,
    nav: 72.15,
    price: 72.18,
    change: 0.25,
    ...
    trackingError: 0.02,
    holdings: [
      { symbol: "UST-10Y", name: "US Treasury 10Y", percentage: 25.3 },
      { symbol: "MSFT-21", name: "Microsoft Bond", percentage: 3.2 },
      { symbol: "JNJ-22", name: "J&J Bond", percentage: 2.8 },
    ],
  },
  // Actively Managed ETF
  {
    ...
    market: "NASDAQ",
    holdings: [
      { symbol: "NVDA", name: "NVIDIA", percentage: 8.5 },
      { symbol: "META", name: "Meta Platforms", percentage: 7.2 },
      { symbol: "MSFT", name: "Microsoft", percentage: 6.8 },
    ],
  },
]
...
export const mockMutualFunds: MutualFund[] = [
  {
    id: "mf-001",
    symbol: "VFIAX",
    name: "Vanguard Fidelity 500 Index Fund",
    fundFamily: "Vanguard",
    fundType: "index",
    expenseRatio: 0.04,
    nav: 425.30,
    ...
    aum: "$185.5B",
    yield: 1.45,
    managerName: "Vanguard Index Management Team",
    managerTenure: 15,
    performance1Y: 28.5,
    performance3Y: 12.3,
    performance5Y: 14.8,
    market: "NASDAQ",
    holdings: [
      { symbol: "AAPL", name: "Apple Inc.", percentage: 7.1 },
      { symbol: "MSFT", name: "Microsoft", percentage: 6.9 },
      { symbol: "GOOGL", name: "Alphabet Inc.", percentage: 4.0 },
    ],
  },
  {
    id: "mf-002",
    ...
    market: "NASDAQ",
    holdings: [
      { symbol: "AAPL", name: "Apple Inc.", percentage: 5.2 },
      { symbol: "NVDA", name: "NVIDIA", percentage: 4.8 },
      { symbol: "MSFT", name: "Microsoft", percentage: 4.5 },
    ],
  },
  {
    id: "mf-003",
    ...
    aum: "$45.8B",
    yield: 4.78,
    managerName: "Vanguard Fixed Income Team",
    managerTenure: 12,
    performance1Y: 3.2,
    performance3Y: -1.5,
    performance5Y: 2.8,
    market: "NASDAQ",
    holdings: [
      { symbol: "UST-10Y", name: "US Treasury 10Y", percentage: 22.5 },
      { symbol: "MSFT-21", name: "Microsoft Bond", percentage: 2.1 },
    ],
  },
  {
    id: "mf-004",
    ...
    aum: "$125.3B",
    yield: 1.35,
    managerName: "International Equity Team",
    managerTenure: 18,
    performance1Y: 22.5,
    performance3Y: 9.8,
    performance5Y: 11.5,
    market: "NYSE",
    holdings: [
      { symbol: "AAPL", name: "Apple Inc.", percentage: 3.2 },
      { symbol: "MSFT", name: "Microsoft", percentage: 2.9 },
      { symbol: "RHHBY", name: "Roche", percentage: 1.5 },
    ],
  },
]
