  ...
  const handleAddHolding = () => {
    if (selectedPortfolio && newHolding.symbol && newHolding.quantity) {
      ...
      const updated = {
        ...
        value: selectedPortfolio.value + holding.quantity * holding.currentPrice,
      }
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-card">
        ...
        <PortfolioTypeModal
            ...
            onSelectType={(type) => {
              ...
              if (type === 'inherit') router.push('/dashboard/portfolio/inherit')
              if (type === 'transfer') router.push('/dashboard/transfer/')
            }}
        />
      </div>
  )
